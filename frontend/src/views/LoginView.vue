  ...
  <div class="bg-vault-glow bg-blueprint relative flex min-h-svh items-center justify-center p-6">
    ...
    <Card class="animate-fade-in-up relative w-full max-w-sm border-border/60 shadow-2xl backdrop-blur-sm">
      <CardHeader class="space-y-1 text-center">
        ...
        <p class="text-muted-foreground pt-1 text-sm">Sign in to your pooled drive vault</p>
      </CardHeader>
      <CardContent>
        <form class="flex flex-col gap-5" @submit.prevent="submit">
          ...
          <p class="text-muted-foreground text-center text-sm">
            Need an account?
            <router-link to="/register" class="text-foreground font-medium hover:underline">
              Register
            </router-link>
          </p>
        </form>
